...
data class ContentL(var content_id:String="",var content_url:String="",var content_title:String="",var content_description:String="",var content_play_sequence:String="",
    var isAllowLike:Boolean = false,var isAllowComment:Boolean = false,var isAllowShare:Boolean=false,var question_list:ArrayList<QuestionL> = ArrayList(),var isLiked:Boolean=false
)
...
data class LMS_CONTENT_INFO(var user_id:String = "",var topic_id:Int = 0,var topic_name:String = "",var content_id:Int = 0,
                            var like_flag:Boolean=false,var share_count:Int = 0,var content_length:String = "",
...
data class CommentL(var topic_id:String="",var content_id:String="",var comment_id:String="",var comment_description:String="",var comment_date_time:String="")
