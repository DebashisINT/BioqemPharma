package com.breezebioqempharma.features.logoutsync.presentation
...
import com.breezebioqempharma.CustomConstants
...
import com.breezebioqempharma.app.utils.Toaster
import com.breezebioqempharma.base.BaseResponse
import com.breezebioqempharma.base.presentation.BaseActivity
import com.breezebioqempharma.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezebioqempharma.features.billing.api.AddBillingRepoProvider
import com.breezebioqempharma.features.billing.model.AddBillingInputParamsModel
...
import com.breezebioqempharma.features.dashboard.presentation.ReasonDialog
...
import com.breezebioqempharma.features.document.model.AddEditDocumentInputParams
import com.breezebioqempharma.features.document.model.DocumentAttachmentModel
...
import com.breezebioqempharma.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezebioqempharma.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezebioqempharma.features.orderhistory.model.*
...
import com.breezebioqempharma.features.quotation.model.AddQuotInputModel
import com.breezebioqempharma.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebioqempharma.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezebioqempharma.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezebioqempharma.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezebioqempharma.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezebioqempharma.features.timesheet.model.AddTimeSheetInputModel
import com.breezebioqempharma.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezebioqempharma.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezebioqempharma.features.viewAllOrder.model.AddOrderInputProductList
import com.breezebioqempharma.mappackage.SendBrod
import com.breezebioqempharma.widgets.AppCustomTextView
import com.breezebioqempharma.MonitorService
import com.breezebioqempharma.MySingleton
import com.breezebioqempharma.app.AlarmReceiver
import com.breezebioqempharma.features.addshop.model.*
import com.breezebioqempharma.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezebioqempharma.features.addshop.presentation.ShopExtraContactReq
import com.breezebioqempharma.features.addshop.presentation.multiContactRequestData
...
import com.breezebioqempharma.features.login.model.GetConcurrentUserResponse
...
import com.breezebioqempharma.features.orderITC.SyncDeleteOpptL
import com.breezebioqempharma.features.orderITC.SyncEditOppt
import com.breezebioqempharma.features.orderITC.SyncOppt
import com.breezebioqempharma.features.orderITC.SyncOpptProductL
import com.breezebioqempharma.features.orderITC.SyncOrd
import com.breezebioqempharma.features.orderITC.SyncOrdProductL
import com.breezebioqempharma.features.performance.model.Gps_status_list
import com.breezebioqempharma.features.performance.model.UpdateGpsInputListParamsModel
import com.breezebioqempharma.features.returnsOrder.ReturnProductList
import com.breezebioqempharma.features.returnsOrder.ReturnRequest
import com.breezebioqempharma.features.viewAllOrder.model.NewOrderSaveApiModel
    ...
    fun syncAudioDataNew(){
        try {
            ...
            if(Pref.IsUserWiseRecordAudioEnableForVisitRevisit && unsyncAudioNw.size>0){
                ...
                var shopVisitImageUploadInputModel = ShopVisitImageUploadInputModel()
                shopVisitImageUploadInputModel.shop_id = obj.shop_id
                shopVisitImageUploadInputModel.visit_datetime = obj.datetime
                shopVisitImageUploadInputModel.user_id = Pref.user_id
                shopVisitImageUploadInputModel.session_token = Pref.session_token

                val repository = ShopVisitImageUploadRepoProvider.provideAddShopRepository()
                BaseActivity.compositeDisposable.add(
                    repository.syncShopNewAudio(shopVisitImageUploadInputModel, obj.audio_path, mContext)
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribeOn(Schedulers.io())
                        .subscribe({ result ->
                            val logoutResponse = result as BaseResponse
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebioqempharmalogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebioqempharmalogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebioqempharmalogsample/log.zip").path);
